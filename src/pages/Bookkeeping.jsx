...
/* =========================================================
   ...
   Spending menggunakan amount_out
   untuk Studio Expenses.
========================================================= */
...
/* =========================================================
   STUDIO EXPENSE CATEGORY DETECTION

   Dibuat fleksibel untuk beberapa kemungkinan
   penamaan category pada database.
========================================================= */
...
function isStudioExpense(item) {
  ...
  return normalizedValues.some(
    (value) =>
      value === "expense" ||
      value === "expenses" ||
      value === "studio expense" ||
      value === "studio expenses"
  );
}
...
========================================================= */
  ...
  /* =========================================================
     FILTER STUDIO EXPENSES BY DATE

     IMPORTANT:
     Tanggal Spending dinormalisasi terlebih dahulu
     agar timestamp tetap terbaca.
========================================================= */
    ...
    async () => {
      ...
      try {
        ...
        const settingsData = {
          ...
          additional_expenses:
            settings.additional_expenses.map(
              (item) => ({
                id:
                  item.id,
...
========================================================= */
  ...
  const downloadPDF =
    (report) => {
      ...
      /*
       * IMPORTANT:
       * Jangan mengambil spending_items dari
       * normalizeSettings() karena fungsi tersebut
       * hanya menormalisasi setting utama.
       *
       * Ambil langsung dari raw settings_data.
       */
      ...
      /*
       * FALLBACK UNTUK REPORT LAMA
       *
       * Report yang dibuat sebelum spending_items
       * disimpan di settings_data akan mencoba
       * mengambil data langsung dari state spending.
       */
